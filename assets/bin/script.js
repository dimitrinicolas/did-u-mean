...
var Input = React.createClass({displayName: 'Input',
	...
	render: function() {
		...
		return (
			...
			React.createElement("input", {type: "text", className: className, onChange: this.onChange, placeholder: "Type here...", autoFocus: true, autoComplete: "off", autoCorrect: "off", spellCheck: "false"})
...
onload(function() {
	...
	React.render(
		...
		React.createElement("div", null, 
			...
			React.createElement("input", {className: "input", type: "text", id: "result"})
		),
